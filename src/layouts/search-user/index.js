...
const SearchUser = (props) => {
    ...
    return (
        <div className="search-user-wrapper text-center">
            {!localStorage.getItem("token") ? <p className="connection-login-message">You are not connected, please <button onClick={props.loginHandler}>Login</button> or <button onClick={props.registerHandler}>Register</button> for better matches!</p> : ""}
